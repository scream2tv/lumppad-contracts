# LumpPad Contracts 1,000,000,000 | 40,000,000 | 3,000,000 lovelace | 100 | 50 | 40,000 | 30 |
...
`cardano-v4-aliens` — ALIENS-quoted:

| Script | Hash |
|---|---|
| `lump_pool_v4` (spend) | `a058ce46436b03725cdedefd45c72348818e6d801e3115e578bede71` |
| `lump_mint_v4` (mint, **unapplied**) | `3f903c86bfad364cd6e8b5d6672402a60eddf6c6842aa9cf36dee646` |
